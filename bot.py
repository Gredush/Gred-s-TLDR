...
async def tldr(interaction: discord.Interaction, hours: int):
    ...
    system_prompt = (
        ...
        "3. Αν υπήρξαν χρήσιμα links, αποφάσεις ή εκκρεμότητες, σημείωσέ τα σε ξεχωριστή υπο-ενότητα στο τέλος.\n"
        "4. Κράτα το ύφος φυσικό, φιλικό και ευανάγνωστο, αποφεύγοντας υπερβολικά σύντομες προτάσεις."
    )
