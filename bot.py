...
async def fetch_and_generate_tldr(channel: discord.TextChannel, hours: int) -> str | None:
    ...
    system_prompt = (
        ...
        "Μετάφρασε/απόδωσε τους όρους Greeklish ή αγγλικής αργκό στη δημοτική ελληνική με φυσικό τρόπο (π.χ. 'raid' -> 'επιδρομή/raid', 'm+' -> 'Mythic+ dungeoneering').\n"
        ...
        "• **[Όνομα Θέματος 1]:** Σύντομη και σαφής περιγραφή του τι συζητήθηκε και από ποιους (αν είναι σχετικό).\n"
        "• **[Όνομα Θέματος 2]:** Σύντομη και σαφής περιγραφή.\n\n"
        ...
        "### ΠΕΡΙΟΡΙΣΜΟΣ ΜΗΚΟΥΣ:\n"
        "Κράτα τη συνολική απάντηση σύντομη και ευανάγνωστη (περίπου 150-250 λέξεις)."
    )
